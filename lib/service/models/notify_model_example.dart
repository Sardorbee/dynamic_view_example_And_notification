...
List<NotifyExamplee> notifyExampleeFromJson(String str) => List<NotifyExamplee>.from(json.decode(str).map((x) => NotifyExamplee.fromJson(x)));

String notifyExampleeToJson(List<NotifyExamplee> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class NotifyExamplee {
    String id;
    String name;
    Data? data;
    ...
    factory NotifyExamplee.fromJson(Map<String, dynamic> json) => NotifyExamplee(
        id: json["id"],
        name: json["name"],
